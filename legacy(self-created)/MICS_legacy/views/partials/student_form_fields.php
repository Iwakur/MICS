...
<div class="form-grid">
    ...
    <label class="field">
        ...
        <?php if (isset($errors['plan_id'])): ?><small class="field-error"><?= e($errors['plan_id']) ?></small><?php endif; ?>
    </label>
    ...
    <label class="field">
        ...
        <?php if (isset($errors['discount_amount'])): ?><small class="field-error"><?= e($errors['discount_amount']) ?></small><?php endif; ?>
    </label>

    <label class="field">
        <span>Joined At</span>
        <input type="datetime-local" name="joined_at" value="<?= e($values['joined_at']) ?>" required>
        <?php if (isset($errors['joined_at'])): ?><small class="field-error"><?= e($errors['joined_at']) ?></small><?php endif; ?>
    </label>
</div>
