...
<div class="form-grid">
    <label class="field">
        ...
        <?php if (isset($errors['expense_date'])): ?><small class="field-error"><?= e($errors['expense_date']) ?></small><?php endif; ?>
    </label>
    ...
    <label class="field">
        ...
        <?php if (isset($errors['category_id'])): ?><small class="field-error"><?= e($errors['category_id']) ?></small><?php endif; ?>
    </label>
    ...
    <label class="field">
        ...
        <?php if (isset($errors['paid_from_account_id'])): ?><small class="field-error"><?= e($errors['paid_from_account_id']) ?></small><?php endif; ?>
    </label>
