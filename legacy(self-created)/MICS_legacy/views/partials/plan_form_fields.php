...
<div class="form-grid">
    ...
    <label class="field">
        ...
        <?php if (isset($errors['lesson_count'])): ?><small class="field-error"><?= e($errors['lesson_count']) ?></small><?php endif; ?>
    </label>

    <label class="field">
        <span>Lesson Price</span>
        <input type="number" name="lesson_price" value="<?= e($values['lesson_price']) ?>" min="0" step="0.01" required>
        <?php if (isset($errors['lesson_price'])): ?><small class="field-error"><?= e($errors['lesson_price']) ?></small><?php endif; ?>
    </label>
    ...
    <label class="field">
        ...
        <?php if (isset($errors['teacher_share_per_lesson'])): ?><small class="field-error"><?= e($errors['teacher_share_per_lesson']) ?></small><?php endif; ?>
    </label>
    ...
    <label class="field">
        ...
        <?php if (isset($errors['assignable_state'])): ?><small class="field-error"><?= e($errors['assignable_state']) ?></small><?php endif; ?>
    </label>
</div>
