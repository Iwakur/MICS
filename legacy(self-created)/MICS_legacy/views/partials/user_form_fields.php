...
<div class="form-grid">
    ...
    <label class="field">
        ...
        <?php if (isset($errors['username'])) { ?><small class="field-error"><?= e($errors['username']) ?></small><?php } ?>
    </label>
    ...
    <label class="field">
        ...
        <?php if (isset($errors['is_active'])) { ?><small class="field-error"><?= e($errors['is_active']) ?></small><?php } ?>
    </label>
</div>
