...
<div class="form-grid">
    <label class="field">
        ...
        <?php if (isset($errors['student_id'])): ?><small class="field-error"><?= e($errors['student_id']) ?></small><?php endif; ?>
    </label>

    <label class="field">
        <span>Payment Date</span>
        <input type="datetime-local" name="payment_date" value="<?= e($values['payment_date']) ?>" required>
        <?php if (isset($errors['payment_date'])): ?><small class="field-error"><?= e($errors['payment_date']) ?></small><?php endif; ?>
    </label>
    ...
    <label class="field">
        ...
        <?php if (isset($errors['method'])): ?><small class="field-error"><?= e($errors['method']) ?></small><?php endif; ?>
    </label>

    <label class="field">
        <span>Source</span>
        <input type="text" name="source" value="<?= e($values['source']) ?>" required>
        <?php if (isset($errors['source'])): ?><small class="field-error"><?= e($errors['source']) ?></small><?php endif; ?>
    </label>
    ...
    <label class="field">
        ...
        <?php if (isset($errors['covered_month'])): ?><small class="field-error"><?= e($errors['covered_month']) ?></small><?php endif; ?>
    </label>
</div>
